    ...
    <div className={styles.bodyContainer}>
      <div className={styles.blurbContainer}>
        <p className={styles.blurb}>
          ...
          journey with Pet Taskmaster and receive your first pet for free!
          Engage in delightful activities, earn points, and unlock a world of
          ...
          regular updates keep the excitement alive. Pet Taskmaster - Unleash
          the joy of virtual companionship. Join now and make every click count!
        </p>
      </div>
