...
{section === 'namePet' && (
      ...
      <div className={styles.namePetContainer}>
        ...
        />{' '}
        <button className={styles.petNameSubmitBtn} onClick={handleSubmitName}>Submit</button>
      </div>
      </>
      )}
{/* Congrats section */}
{section === 'congrats' && <div className={styles.congratsContainer}>
        ...
        <p className={styles.paraText}>
          ...
          journey. Your pet is eager to grow and evolve, and it's all up to you
          now.
        </p>{' '}
        <br />
        <p className={styles.paraText}>
        ...
        <br />
        <p className={styles.paraText}>
          So, let's get started! Your pet is excited to see what you can achieve
          together.
        </p>
        <br />
        <p className={styles.paraText}>
          Click on your pet for more details or go to your tasks to get started!
        </p>
        <br />
